                        ...
                        <div id="main" class="col-lg-12 col-md-12 col-sm-12">   
                            <div id="my-cart">
                                <div class="row">
                                    ...
                                    <div class="cart-nav-item col-lg-2 col-md-7 col-sm-12">Customer</div>
                                    <div class="cart-nav-item col-lg-2 col-md-7 col-sm-12">Address</div>
                                    <div class="cart-nav-item col-lg-1 col-md-7 col-sm-12">Phone</div>
                                    <div class="cart-nav-item col-lg-2 col-md-7 col-sm-12">Email</div>
                                    <div class="cart-nav-item col-lg-1 col-md-3 col-sm-12">Date</div>
                                    <div class="cart-nav-item col-lg-1 col-md-1 col-sm-12">Details</div>
                                </div>
                                <form method="post" action = "">
                                    <?php
                                    $i = 0;
                                        foreach ($list[1] as $queryL) {
                                            $i++;
                                    ?>
                                    <div class="cart-item row">
                                        ...
                                        <div class="cart-thumb col-lg-2 col-md-7 col-sm-12">
                                            <?= $queryL['admin_address'] ?>
                                        </div>
                                        <div class="cart-thumb col-lg-1 col-md-7 col-sm-12">
                                            <?= $queryL['admin_phone'] ?>
                                        </div>
                                        <div class="cart-thumb col-lg-2 col-md-1 col-sm-12">
                                            <?= $queryL['admin_email'] ?>
                                        </div>
                                        <div class="cart-thumb col-lg-1 col-md-7 col-sm-12">
                                            <?= $queryL['date_print'] ?>
                                        </div>
                                        <div class="cart-thumb col-lg-1 col-md-1 col-sm-12">
                                            <a href="index.php?controller=customer&action=order_detail&id=<?= $queryL['order_id'] ?>">detail</a>
                                        </div>
                                    </div>
                                    <?php
                                        }
                                ...
                                <a href="index.php?controller=customer&action=cart_view"class="btn btn-success" type="submit" >Back</a>
                            </div>
                        </div>                   
                    </div>
                </div>
