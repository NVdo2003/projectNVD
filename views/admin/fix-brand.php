	...
	<div class="wrapper">
		<div class="main-header">
			...
			<div class="main-panel">
				<div class="content">
					<div class="container-fluid">
						<h3 class="page-title">Fix Brand</h3>
                        <div class="col-md-8">
                            <?php
                                foreach ($brand as $bran){
                            ?>
                                <form role="form" action="index.php?controller=brand&action=update" method="post">
                                    <input type="hidden" name="brand_id" value="<?= $bran['brand_id'] ?>">
                                    <div class="form-group">
                                        <h6>
                                        Name list:
                                        </h6>
                                        <input type="text" name="brand_name" value="<?= $bran['brand_name'] ?>" class="form-control" placeholder="Name list...">
                                        <br>
                                    </div>
