						...
						<div class="card">
							<div class="card-header">
								<div id="toolbar" class="btn-group">
									<a href="index.php?controller=payment&action=create" class="btn btn-success">
							...
							<table class="table mt-3">
								...
								<tbody>
									...
									?>
									<tr>
										<td><?= $paymen['payment_id'] ?></td>
										<td><?= $paymen['payment_method'] ?></td>
										<td><a href="index.php?controller=payment&action=edit&payment_id=<?= $paymen['payment_id'] ?>" class="btn btn-warning" tabindex="-1" role="button" aria-disabled="true">Fix</a>
											<a href="index.php?controller=payment&action=destroy&payment_id=<?= $paymen['payment_id'] ?>" class="btn btn-primary" tabindex="-1" role="button" aria-disabled="true">Delete</a></td>
									</tr>
									<?php
									    }
									?>
