				...
				<div class="content">
					<div class="container-fluid">
						<h3 class="page-title">Add category</h3>
                            <div class="col-8">
                                <form role="form" action="index.php?controller=category&action=store" method="post">
                                <div class="form-group">
                                    <h6>
                                    Name list:
                                    </h6>
                                    <input type="text" name="category_name" class="form-control" placeholder="Name list...">
									<br>
								</div>
                                <button type="submit" name="sbm" value="Add new" class="btn btn-info">Add new</button>
