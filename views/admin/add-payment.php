				...
				<div class="content">
					<div class="container-fluid">
						<h3 class="page-title">Add Payment</h3>
                            <div class="col-8">
                                <form role="form" action="index.php?controller=payment&action=store" method="post">
                                <div class="form-group">
                                    <h6>
                                    Name list:
                                    </h6>
                                    <input type="text" name="payment_method" class="form-control" placeholder="Name list...">
									<br>
								</div>
