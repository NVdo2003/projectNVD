            ...
            <div class="container-fluid">
                ...
                <div class="col-9">
                    <?php
                        foreach ($user as $use) {
                    ?>
                    <form role="form" method="post" action="index.php?controller=users&action=update">
                        <input type="hidden" name="user_id" value="<?= $use['user_id'] ?>">
                        <div class="form-group">
                            <label>First and last name</label>
                            <input name="user_name" value="<?= $use['user_name'] ?>" required class="form-control" placeholder="">
                        </div>
                        <div class="form-group">
                            <label>Email</label>
                            <input name="user_email" value="<?= $use['user_email'] ?>" required type="text" class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Password</label>
                            <input name="user_password" value="<?= $use['user_password'] ?>" required type="text"  class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select name="user_level" class="form-control">
                                <option value="<?= $use['user_level'] == 1?>">Admin</option>
                                <option value="<?= $use['user_level'] == 1?>">Member</option>
                            </select>
                        </div>
                        <br>
