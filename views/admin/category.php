						...
						<div class="card">
							...
							<table class="table mt-3">
								...
								<tbody>
									...
									?>
									<tr>
										<td><?= $categor['category_id'] ?></td>
										<td><?= $categor['category_name'] ?></td>
										<td><a href="index.php?controller=category&action=edit&category_id=<?= $categor['category_id'] ?>" class="btn btn-warning" tabindex="-1" role="button" aria-disabled="true">Fix</a>
											<a href="index.php?controller=category&action=destroy&category_id=<?= $categor['category_id'] ?>" class="btn btn-primary" tabindex="-1" role="button" aria-disabled="true">Delete</a></td>
									</tr>
									<?php
									    }
									?>
