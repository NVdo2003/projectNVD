	...
	<div class="wrapper">
		<div class="main-header">
			...
			<div class="main-panel">
				<div class="content">
					<div class="container-fluid">
						<h3 class="page-title">Fix category</h3>
                        <div class="col-md-8">
                            <?php
                                foreach ($category as $categor){
                            ?>
                                <form role="form" action="index.php?controller=category&action=update" method="post">
                                    <input type="hidden" name="category_id" value="<?= $categor['category_id'] ?>">
                                    <div class="form-group">
                                        <h6>
                                        Name list:
                                        </h6>
                                        <input type="text" name="category_name" value="<?= $categor['category_name'] ?>" class="form-control" placeholder="Name list...">
                                        <br>
                                    </div>
                                    <button type="submit" name="sbm" class="btn btn-info">Update</button>
