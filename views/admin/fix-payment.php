	...
	<div class="wrapper">
		<div class="main-header">
			...
			<div class="main-panel">
				<div class="content">
					<div class="container-fluid">
						<h3 class="page-title">Fix Payment</h3>
                        <div class="col-md-8">
                            <?php
                                foreach ($payment as $paymen){
                            ?>
                                <form role="form" action="index.php?controller=payment&action=update" method="post">
                                    <input type="hidden" name="payment_id" value="<?= $paymen['payment_id'] ?>">
                                    <div class="form-group">
                                        <h6>
                                        Name list:
                                        </h6>
                                        <input type="text" name="payment_method" value="<?= $paymen['payment_method'] ?>" class="form-control" placeholder="Name list...">
                                        <br>
                                    </div>
