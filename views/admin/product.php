		...
		<div class="main-header">
			...
			<nav class="navbar navbar-header navbar-expand-lg">
				<div class="container-fluid">
					<form class="navbar-left navbar-form nav-search mr-md-3" method="post" action="index.php?controller=product" style="width: 30%">
						<div class="input-group">
							<input type="text" placeholder="Search ..." name="search" value="<?= $array['search'] ?>" class="form-control">
			...
			<div class="main-panel">
				<div class="content">
					<div class="container-fluid">
						...
						<div class="card">
							...
							<div id="toolbar" class="btn-group">
								...
								<table class="table mt-3">
									...
									<tbody>
										<?php
											foreach ($array['product'] as $produc ){
										...
										?>
											<tr>
                                                ...
                                                <td><img src="views/admin/img/<?= $produc['product_img']; ?>" class="rounded mx-auto d-block" alt="" width="150" height="150"></td>
												<td>
													<?php
														if($produc['product_status'] == 1) {
															echo '<span class="badge text-bg-info">Stocking</span>';
														}else{
															echo '<span class="badge text-bg-success">Out of stock</span>';
														}
													?>
												</td>
												<td><?= $produc['category_id'] ?></td>
												<td><?= $produc['brand_id'] ?></td>
												<td><a href="index.php?controller=product&action=edit&product_id=<?= $produc['product_id']; ?>" class="btn btn-warning" tabindex="-1" role="button" aria-disabled="true">Fix</a>
													<a href="index.php?controller=product&action=destroy&product_id=<?= $produc['product_id']; ?>" class="btn btn-primary" tabindex="-1" role="button" aria-disabled="true">Delete</a></td>
											</tr>
										<?php
						...
						?>
							<form style="display: inline-block" class="panel-footer" action="index.php?controller=product" method = "post">
