						...
						<div class="card">
							<div class="card-header">
								<div id="toolbar" class="btn-group">
									<a href="index.php?controller=brand&action=create" class="btn btn-success">
							...
							<table class="table mt-3">
								...
								<tbody>
									...
									<tr>
										...
										<td><a href="index.php?controller=brand&action=edit&brand_id=<?= $bran['brand_id'] ?>" class="btn btn-warning" tabindex="-1" role="button" aria-disabled="true">Fix</a>
											<a href="index.php?controller=brand&action=destroy&brand_id=<?= $bran['brand_id'] ?>" class="btn btn-primary" tabindex="-1" role="button" aria-disabled="true">Delete</a></td>
									</tr>
									<?php
									    }
									?>
