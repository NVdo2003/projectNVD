				...
				<div class="content">
					<div class="container-fluid">
						...
						<div class="card">
							...
							<table class="table mt-3">
								...
								<tbody>
									...
									<tr>
										...
										<td><?= $order['date_print'] ?></td>
                                        <!-- <td><?= $order['status'] ?></td> -->
										<td>
											<?php
												if($order['status'] == 1) {
													echo '<span class="badge text-bg-info">Pending</span>';
												}elseif ($order['status'] == 2){
													echo '<span class="badge text-bg-success">Shipping</span>';
												}
											?>
										</td>
										...
										<td><a href="index.php?controller=order&action=ship&id=<?= $order['order_id'] ?>" class="btn btn-warning" tabindex="-1" role="button" aria-disabled="true">OK</a>
										</td>
									</tr>
									<?php
									    }
							...
							<a href="index.php?controller=order&action=admin_history" class="btn btn-info" tabindex="-1" role="button" aria-disabled="true">Customer Detail</a>
						</div>
					</div>
				</div>
			</div>
