						...
						<div class="card">
							...
							<table class="table mt-3">
								...
								<tbody>
									<?php 
                                    $i = 0;
										foreach ($queryLKc as $queryLK) {
                                    $i++;
									?>
									<tr>
                                        <td><?= $i ?></td>
										<td><?= $queryLK['order_id'] ?></td>
										<td><?= $queryLK['admin_name'] ?></td>
                                        <td><?= $queryLK['admin_address'] ?></td>
                                        <td><?= $queryLK['admin_phone'] ?></td>
                                        <td><?= $queryLK['admin_email'] ?></td>
                                        <td><?= $queryLK['date_print'] ?></td>
										<td><a href="index.php?controller=order&action=admin_detail&id=<?= $queryLK['order_id'] ?>" class="btn btn-warning" tabindex="-1" role="button" aria-disabled="true">OK</a>
										</td>
									</tr>
									<?php
									    }
							...
							<a href="index.php?controller=order" class="btn btn-info" tabindex="-1" role="button" aria-disabled="true">Back</a>
						</div>
					</div>
				</div>
			</div>
